...
import net.minecraft.server.v1_5_R1.CraftingManager;
import net.minecraft.server.v1_5_R1.IRecipe;
import net.minecraft.server.v1_5_R1.Item;
import net.minecraft.server.v1_5_R1.ItemStack;
import net.minecraft.server.v1_5_R1.RecipesFurnace;
...
public class RealRecipe
{
	...
	public static Set<RealRecipe> getItemRecipes(RealItemType realItemType)
	{
		...
		for (Object recipe : CraftingManager.getInstance().getRecipes()) {
			net.minecraft.server.v1_5_R1.ItemStack itemStack = ((IRecipe)recipe).b();
			if (itemStack != null) {
